...
RUN pip3 install deprecation==2.1.0 graphviz==0.20.3 intervaltree==3.1.0 networkx==3.3 packaging==24.1 python-dateutil==2.9.0.post0 pytz==2024.1 setuptools==71.0.1 six==1.16.0 sortedcontainers==2.4.0 tzdata==2024.1 wheel==0.43.0 
...
RUN pip3 install anyio==4.4.0 asttokens==2.4.1 attrs==23.2.0 backcall==0.2.0 certifi==2024.7.4 charset-normalizer==3.3.2 decorator==5.1.1 distro==1.9.0 executing==2.0.1 h11==0.14.0 httpcore==1.0.5 httpx==0.27.0 idna==3.7 ipython==8.26.0 jedi==0.19.1 Jinja2==3.1.4 jsonpickle==3.2.2 jsonschema-specifications==2023.12.1 MarkupSafe==2.1.5 matplotlib-inline==0.1.7 parso==0.8.4 pickleshare==0.7.5 prompt-toolkit==3.0.47 pure-eval==0.2.2 pydantic==2.8.2 Pygments==2.18.0 referencing==0.35.1 rpds-py==0.19.0 sniffio==1.3.1 stack-data==0.6.3 traitlets==5.14.3 typing_extensions==4.12.2 urllib3==2.2.2 wcwidth==0.2.13 
RUN pip3 install jsonschema==4.23.0 openai==1.35.14 pyvis==0.3.2 requests==2.32.3 
